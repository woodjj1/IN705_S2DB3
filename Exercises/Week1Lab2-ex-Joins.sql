...
4.3	List all the full names of all the people who have never enrolled in a paper
	...
	Select distinct Fullname from Person left outer join Enrolment on Enrolment.PersonId = Person.PersonId
